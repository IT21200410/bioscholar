...
const docs = [
  ...
  { title: 'Project Proposal', desc: 'The document contains details like goals, objectives, important dates, milestones and requirements needed to start and complete the project.', img: Project_proposal, link: 'https://drive.google.com/drive/folders/1ZMsOYW7CQCyDs3AYO-oTuXMZPbKJe0sT?usp=sharing' },
  ...
  { title: 'Check List', desc: 'The document describes the progress of the project within the specific time period and compares it against the project plan checklist', img: Status, link: 'https://drive.google.com/drive/folders/1SYXmautiarklPjdsokupsvE1IIqt_WaR?usp=sharing' },
